...
namespace Shelf.Support
{
    ...
    /// </summary>
    /// <remarks>
    /// Can serialize and deserialize any type of serializable object 
    /// Use Xml (String) or Binary (Byte[]) datastructures or read/write files of both types.
    /// This is a *static* class to provide simple, single-line, typed access to Serialization.
    /// </remarks>
    /// <typeparam name="T">Type/Class that you wish to serialize/deserialize/</typeparam>
    public static class Persistance<T> // where T : ISerializable // prevents string[] from being Serialized
    {
