...
namespace Shelf.Support.Semantics.WordNet.Common
{
	public class Definition
	{
		...
		private Definition mNextDefinition;		/* ptr to next definition containing searchword */
		private Definition mNextForm;	/* ptr to list of definitions for alternate spelling of wordform */
		private int mSearchType;		/* type of search performed */
		private Definition mPtrList;		/* ptr to definition list result of search */
		...
		public string DisplayPartOfSpeech
		{
			get
			{
				...
				{
					retVal = ( ( DbPartOfSpeechType )PtrPartOfSpeech[0] ).ToString();
				}
				else
				{
		...
		///</summary>
		public Definition NextDefinition { get { return mNextDefinition; } set { mNextDefinition = value; } }
		...
		///</summary>
		public Definition NextForm { get { return mNextForm; } set { mNextForm = value; } }
		#endregion NextForm
		...
		///</summary>
		public Definition PtrList { get { return mPtrList; } set { mPtrList = value; } }
		#endregion PtrList
