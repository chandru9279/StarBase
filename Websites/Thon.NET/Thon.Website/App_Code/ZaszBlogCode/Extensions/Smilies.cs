...
/// </remarks>
[Extension("Converts ASCII smilies into real smilies in the comments", "1.2", "Thon.ZaszBlog")]
public class Smilies
{
  ...
  private const string LINK = "<img src=\"{0}Admin/TinyMCE/plugins/emotions/images/smiley-{1}.gif\" class=\"flag\" alt=\"{2}\" />";
  ...
  {
    return string.Format(LINK, SupportUtilities.RelativeWebRoot, name, alt);
  }
}