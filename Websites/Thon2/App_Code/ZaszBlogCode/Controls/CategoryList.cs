		...
		private HtmlGenericControl BindCategories()
		{
			...
			foreach (string key in dic.Keys)
			{
				...
				if (ShowRssIcon)
				{
                    ...
                    feedAnchor.HRef = SupportUtilities.RelativeWebRoot + "ZaszBlogHttpHandlers/Syndication.ashx?category=" + dic[key].ToString();
				...
				anc.HRef = SupportUtilities.RelativeWebRoot + "category/" + SupportUtilities.RemoveIllegalCharacters(key) + BlogSettings.Instance.FileExtension;
