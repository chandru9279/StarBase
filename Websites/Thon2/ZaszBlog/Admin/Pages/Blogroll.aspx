<%@ Page AutoEventWireup="true" CodeFile="Blogroll.aspx.cs" Inherits="AdminBlogroll"
    Language="C#" MasterPageFile="~/ZaszBlog/Admin/ZaszBlogAdmin.master" Title="Blogroll" %>
...
<div class="settings">
 ...
 <label for="<%=ddlVisiblePosts.ClientID %>" class="wide"># of displayed items</label>
  ...
  <label for="<%=txtMaxLength.ClientID %>" class="wide">Max length of items</label>
  ...
  <label for="<%=txtUpdateFrequency.ClientID %>" class="wide">Update frequency (minutes)</label>
  ...
  <div style="text-align:right">
    <asp:Button runat="server" ID="btnSaveSettings" ValidationGroup="settings" Text="Save Settings"/>
  </div>
...
<div class="settings">
  ...
  <div style="text-align:right">
    <asp:Button runat="server" ID="btnSave" Text="Add" />
  </div>
  ...
  <asp:Repeater runat="Server" ID="rep">
    ...
    <ItemTemplate>
      <tr>
        <td>
          <a href="<%#((System.Xml.XmlNode)Container.DataItem).Attributes["xmlUrl"].Value %>"><img src="../../Images/RSSButton.gif" alt="RSS feed" /></a>
