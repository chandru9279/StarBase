...
public partial class AdminReferrers : System.Web.UI.Page
{
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    {      
      ...
      {
        BindDays();
        BindReferrers(DateTime.Now.ToString("dddd"));
      }
      else
      {
      ...
      cbEnableReferrers.Checked = ThonSettings.Instance.EnableReferrerTracking;
    }
  ...
  private void cbEnableReferrers_CheckedChanged(object sender, EventArgs e)
  {
    ...
    ThonSettings.Instance.EnableReferrerTracking = cbEnableReferrers.Checked;
  ...
  private void BindDays()
  {
    ...
    foreach (ListItem item in ddlDays.Items)
    {
      ...
      if (item.Value == DateTime.Now.ToString("dddd"))
      {
        item.Selected = true;
      }
