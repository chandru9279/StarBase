    ...
    private string GetExtensions()
    {
        ...
        if (extList != null)
        {
            ...
            foreach (ManagedExtension x in extList)
            {
                ...
                {
                    string url = SupportUtilities.AbsoluteWebRoot.AbsoluteUri;
                    if (!url.EndsWith("/"))
                        url += "/";
                    ...
                    sb.Append("<td align='center'><a href='" + url + "'>Edit</a></td>");
                }
                else
                {
                    if (x.Settings == null)
                    ...
                    {
                        sb.Append("<td align='center'><a href='?ctrl=params&ext=" + x.Name + "'>Edit</a></td>");
                    }
                }
