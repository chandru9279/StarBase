<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Settings.ascx.cs" Inherits="ExtensionParameters" %>
...
<asp:Button runat="server" ID="btnAdd" Text="Save" ValidationGroup="new" 
