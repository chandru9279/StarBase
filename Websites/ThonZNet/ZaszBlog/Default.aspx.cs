...
{
    public partial class ZaszBlogDefaultAspx : BlogBasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Thon.ZaszBlog.Support.CodedRepresentations.Page frontPage = Thon.ZaszBlog.Support.CodedRepresentations.Page.GetFrontPage();
            if (Request.QueryString.Count == 0 && frontPage != null)
            {
                Server.Transfer(SupportUtilities.RelativeWebRoot + "Page.aspx?id=" + frontPage.Id);
            }
            ...
            else if (Request.QueryString.Count == 0 || !string.IsNullOrEmpty(Request.QueryString["page"]) || !string.IsNullOrEmpty(Request.QueryString["blog"]))
            {
            ...
            base.AddMetaTag("author", Server.HtmlEncode(ThonSettings.Instance.MyName));
        }
        ...
        private void Redirect()
        {
            ...
            if (!string.IsNullOrEmpty(date))
            {
                ...
                rewrite = SupportUtilities.RelativeWebRoot + dateParsed.Year + "/" + dateParsed.Month + "/" + dateParsed.Day + "/default.aspx";
            }
            else if (!string.IsNullOrEmpty(year) && !string.IsNullOrEmpty(month))
            {
                rewrite = SupportUtilities.RelativeWebRoot + year + "/default.aspx";
            }
